...
No gestation is the best candidate for removal because it has the lowest adjusted $R^2$ and it is below the adjusted $R^2$ of the previous step (the full model).

Why not remove the other terms at the same time?

# Problem 9.9

There are two approaches to adding features in forward/backward selection. You can base it off the adjusted $R^2$ or the p-value. In the case of the adjusted $R^2$ you add the feature that has the highest adjusted $R^2$ iff it is above the previous model. In the case of the p-value you add the feature that is most significant. 
